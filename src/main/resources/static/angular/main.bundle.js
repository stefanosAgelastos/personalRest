...
var AppNavbarComponent = /** @class */ (function () {
    function AppNavbarComponent(router, guard) {
        var _this = this;
        this.router = router;
        this.guard = guard;
    ...
    AppNavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_0__auth_guard__["a" /* AuthGuard */]])
    ], AppNavbarComponent);
